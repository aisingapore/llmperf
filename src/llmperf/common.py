...
from llmperf.ray_clients.triton_chat_completions_client import TritonChatCompletionsClient
from llmperf.ray_llm_client import LLMClient


SUPPORTED_APIS = ["openai", "anthropic", "litellm", "triton"]
...
def construct_clients(llm_api: str, num_clients: int) -> List[LLMClient]:
    ...
    if llm_api == "openai":
        ...
        clients = [TritonChatCompletionsClient.remote() for _ in range(num_clients)]
